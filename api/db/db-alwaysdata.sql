...
INSERT INTO user(id, email, password, first_name, idRole) VALUES
    ...
    ,(8, 'prof5@mail.fr', 'mdp','Paul', 20)
    ,(9, 'prof6@mail.fr', 'mdp','Jean', 20)
;
...
,('ref126', 'Cours de musique', 'https://www.symphonie41.fr/media/wysiwyg/cours2.jpg',"Explorez les subtilités du solfège avec des cours particuliers adaptés à votre niveau ! En tant que passionné de musique et pédagogue expérimenté, je vous propose un accompagnement personnalisé, que vous soyez débutant, musicien en herbe ou désireux d'approfondir vos connaissances en solfège.\n\nLes séances se concentreront sur la compréhension des notes, des rythmes, des clés musicales et des principes de la théorie musicale. Ma méthode interactive s'ajuste à votre rythme d'apprentissage, mettant l'accent sur des exercices pratiques et des applications concrètes.", 'Lieu public', 'Gardanne', 35.00, '2023-12-29 14:00:00', false, 7)
,('ref131', 'Cours de langues étrangères (Anglais, Espagnol)', 'https://www.quizz.biz/uploads/article/59/large/1.jpg', "Améliorez vos compétences linguistiques avec des cours de langues étrangères adaptés à votre niveau ! Enseignant polyglotte, je vous offre un apprentissage interactif axé sur la conversation, la grammaire et la culture des langues anglaise et espagnole.", 'En ligne', 'Global', 35.00, '2023-12-31 17:00:00', true, 8)
,('ref127', 'Cours de sciences physiques pour lycéens', 'https://www.cours-thales.fr/wp-content/uploads/2022/06/physique-chimie.jpg', "Améliorez vos connaissances en sciences physiques avec des cours particuliers adaptés à votre niveau ! Enseignant spécialisé, je propose un soutien personnalisé pour les lycéens, en mettant l'accent sur la compréhension des concepts, la résolution d'exercices et la préparation aux examens.", 'Chez vous', 'Aubagne', 30.00, '2023-12-30 10:00:00', true, 9)
;
