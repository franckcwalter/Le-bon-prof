DROP DATABASE IF EXISTS `fwa-devid-final-project`;

CREATE DATABASE IF NOT EXISTS `fwa-devid-final-project` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

USE `fwa-devid-final-project`;

/*
DROP USER IF EXISTS user_dfp;
CREATE USER 'user_dfp'@'localhost' IDENTIFIED BY 'password123';
GRANT SELECT, INSERT, UPDATE, DELETE ON `fwa-devid-final-project`.* TO 'user_dfp'@'localhost';
*/
